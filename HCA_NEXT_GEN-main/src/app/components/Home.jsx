...
import React from 'react';
import { Grid, Link, styled } from '@mui/material';
// Ensure the path to your new logo is correct
import PredictiumLogo from 'app/components/icons/kairos.png';
...
const Home = () => (
  <div style={{ backgroundColor: '#f5f8fa', height: '100%', minHeight: '100vh' }}>
    <MenuPathRoot>
      {/* <MenuPathName>Predictium Health Landing Page</MenuPathName> */}
    </MenuPathRoot>
    ...
    <Grid container spacing={1}>
      ...
      <Grid item xs={12}>
        ...
        <Grid container spacing={1}>
          ...
          <Grid item lg={4}>
            ...
            >
              <p style={{ margin: 0 }}>
                Predictium Health has served as a non-biased third party to investigate worksite clinic
                performance, wellness programs, and worksite safety programs on behalf of various
                self-funded employers, including State and City governments.
              </p>
              <img
      ...
      >
        <div>
          Predictium Health is a health care analytics consulting company, which delivers
          sophisticated data analysis in order to generate evidence-based population health
          management solutions. Predictium Health utilizes a proprietary relational database and reporting
          suite with the ability to integrate, store, and analyze various data sets.
        </div>
      </Grid>
    </Grid>
