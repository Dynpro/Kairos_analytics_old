...
class WeeklyPDFCron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'WeeklyPDF:cron';
    ...
    public function generate_pdf($name,$id,$SectionData,$SubSectionData,$phmData){
        ...
        if(!empty($date_range))
        {
            ...
            try {            
                $pdf = PDF::loadView('reports.view_weekly',compact('SectionData','SubSectionData','phmData','id','ReportData','date_range_data'));
