        ...
        if (!empty($SchemaData)) {
            ...
            try {
                $pdf = PDF::loadView('reports.view', compact('SectionData', 'SubSectionData', 'phmData', 'id', 'ReportData'))
                    ->setPaper('a4', 'portrait') // A4 paper size (portrait or landscape)
                    ->setOption('margin-left', 0) // Left margin
                    ->setOption('margin-right', 20) // Right margin
                    ->setOption('margin-top', 30) // Top margin
